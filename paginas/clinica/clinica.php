...
<html>
	<head>
		...
		<style type="text/css">
			.resultados{width: 100% !important; margin-bottom: 20px !important;}
		</style>
		...
		<script type="text/javascript">
			$(document).ready(function()
			  {
			    //FORMATO DE MASCARAS
			    $('#frascosr').mask('99', {placeholder: '00'});
			    $('#creatininar').mask('99.99999', {placeholder: '00.00000'});
			  });
		</script>
	...
	<body>
		<div class="row" style="margin-top: 110px; background: #FFF; font-size: 10px;">
			...
			<?php
				$sqlu = "SELECT expedienteclinica, nombres, apellidos FROM generales WHERE expedienteclinica = '$expediente'";
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<table class="table table-striped table-bordered table-responsive table-condensed resultados">
								<thead>
									<tr><th colspan="9"><h4>REGISTRO DE MEDICAMENTOS ENTREGADOS, RESULTADOS DE LABORATORIO Y DIAGNOSTICOS CLINICOS</h4></th></tr>
									<tr>
										<th style="width: 08%;"><center>FECHA</center></th>
										<th style="width: 08%;"><center>FRASCOS</center></th>
										<th style="width: 08%;"><center>CREATININA</center></th>
										<th style="width: 08%;"><center>VIH</center></th>
										<th style="width: 08%;"><center>SIFILIS</center></th>
										<th style="width: 08%;"><center>HEPATITIS B</center></th>
										<th style="width: 08%;"><center>HEPATITIS C</center></th>
										<th style="width: 24%;"><center>ITs</center></th>
										<th style="width: 20%;"><center>OBSERVACIONES</center></th>
									</tr>

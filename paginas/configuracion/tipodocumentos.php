...
<html>
	...
	<body>
		<form name="ControlUsuarios" method="POST" action="javascript: GuardarElementos('1');">
			<table class="table table-condensed table-striped table-responsive table-bordered" style="width: 90%; margin: 0 auto;">
				<thead>
					<tr>
						<th colspan="2">ADMINISTRACION DE TIPOS DE DOUMENTOS</th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<table class="table table-bordered table-responsive table-striped table-condensed" style="width: 50%; margin: 0 auto;">
			...
			<tbody>
				<?php
					$sql = "SELECT * FROM tipodocumento ORDER BY correlativo ASC";
									...
									echo
										"
											<tr>
												...
												<td style='width: 75%;'>" . $fila['documento'] . "</td>
											</tr>
										";
								}
						}

...
<html>
	...
	<body>
		<form name="ControlDiagLabsIts" method="POST" action="javascript: GuardarElementos('7');">
			<table class="table table-condensed table-striped table-responsive table-bordered" style="width: 90%; margin: 0 auto;">
				<thead>
					<tr>
						<th colspan="2">ADMINISTRACION DE DIAGNOSTICOS ITs "LABORATORIOS"</th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<table class="table table-bordered table-responsive table-striped table-condensed" style="width: 50%; margin: 0 auto;">
			...
			<tbody>
				<?php
					$sql = "SELECT * FROM diagitslab ORDER BY correlativo ASC";
									...
									echo
										"
											<tr>
												...
												<td style='width: 75%;'>" . $fila['diagnostico'] . "</td>
											</tr>
										";
								}
						}

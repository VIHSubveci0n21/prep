...
(function($){
    var defaults = {
        ...
        // plugin texts
        texts: {
            placeholder    : 'Seleccionar opcion', // text to use in dummy input
            ...
            unselectAll    : 'Deseleccionar todo',   // unselect all text
            noneSelected   : 'No hay seleccion'   // None selected text
        },
